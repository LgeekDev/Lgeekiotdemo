...
## 安装  LgeekBaseIot_19_08_230_debug.apk(调试，有toast) 或者 LgeekBaseIot_19_08_230_release.apk(正式)
...
```groovy
 ...
 implementation 'com.lgeek:iot.parse:19.08.190'     版本号可能在变，可及时与逻辑联系
```
...
| type       | 1.comedy 2.thriller 3.martialArts 4.action 5.scienceFiction  （1.喜剧 2.惊悚 3.武侠 4.动作 5.科幻 6.探索 7.英伦） | 视频类型                 | 否       |
| directors  |                                                              | 导演                     | 否       |
| performers |                                                              | 演员                     | 否       |
| season     | 数值                                                         | 第几季                   | 否       |
| episode    | 数值                                                         | 第几集                   | 否       |
